...
RUNG_MEANING = {
    "PRECHECK": "the link, the vendor and the hoist are all confirmed (feet clear of the floor)",
    ...
    "POSE_MATCH_VERIFIED": "pose and pelvis tilt diagnostics recorded; valid state required",
    ...
    "ARMED": "policy engaged with reference clock paused; explicit play still required",
    "STAND_HOLD": "reference ended in stance; policy remains active while the hoist takes the load",
}
